...
<main class="pb-4 px-4 flex-1 lg:ml-64">
    ...
    <div class="bg-white rounded-lg shadow-md p-5 mt-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <h2 class="text-xl font-semibold text-gray-900 mb-6">Ajouter un client</h2>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-2">
            <div class="flex items-center justify-between mb-6 ms-2 mt-1">
                <h2 class="text-xl font-semibold text-gray-900">Tout les clients</h2>
            </div>

            <div class="space-y-3" id="clientList">
                <!-- Client will be populated here -->
            </div>
            ...
            <div id="emptyState" class="text-center hidden">
                ...
                <p class="text-gray-500">Aucun client pour le moment</p>
                <p class="text-sm text-gray-400 mt-1">Ajoutez votre premier client en utilisant le formulaire
                    ci-dessus</p>
            </div>
        </div>
    </div>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Modifier le client</h3>
        <form id="editForm">
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Nom du client</label>
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
        ...
        <p class="text-gray-700 mb-6">Êtes-vous sûr de vouloir supprimer "<span id="deleteClientName"
