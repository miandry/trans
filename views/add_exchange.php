...
<main class="pb-4 px-4 flex-1 lg:ml-64">
    ...
    <div class="bg-white rounded-lg shadow-md p-5 mt-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <h2 class="text-xl font-semibold text-gray-900 mb-6">Ajouter un cours</h2>

            <form id="exchangeForm" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Montant</label>
                    <input type="number" id="exchangeInput" min="1"
                        ...
                        placeholder="Entrez une montant" required>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-gray-900">Tout les cours</h2>
            ...
            <div class="space-y-3" id="exchangesList">
            ...
            <div id="emptyState" class="text-center py-12 hidden">
                ...
                <p class="text-sm text-gray-400 mt-1">Add your first using the form above</p>
            </div>
        </div>
    </div>
</main>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Modifier le cours</h3>
        <form id="editForm">
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Montant</label>
                <input type="number" min="1" id="editExchange"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all text-sm"
                    required>
            </div>
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
        <div class="flex items-center mb-4">
            ...
            <div>
                <h3 class="text-lg font-semibold text-gray-900">Supprimer le cours</h3>
                <p class="text-sm text-gray-600">Cette action ne peut pas être annulée</p>
            </div>
        </div>
        <p class="text-gray-700 mb-6">Êtes-vous sûr de vouloir supprimer "<span id="deleteMontantValue"
